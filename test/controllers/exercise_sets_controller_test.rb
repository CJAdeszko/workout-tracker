...
class ExerciseSetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise_set" do
    assert_difference("ExerciseSet.count") do
      post exercise_sets_url, params: { exercise_set: { exercise_id: @exercise_set.exercise_id, perceived_exertion: @exercise_set.perceived_exertion, reps: @exercise_set.reps, workout_id: @exercise_set.workout_id } }
    end
  ...
  test "should update exercise_set" do
    patch exercise_set_url(@exercise_set), params: { exercise_set: { exercise_id: @exercise_set.exercise_id, perceived_exertion: @exercise_set.perceived_exertion, reps: @exercise_set.reps, workout_id: @exercise_set.workout_id } }
